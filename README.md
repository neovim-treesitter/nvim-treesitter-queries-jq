# nvim-treesitter-queries-jq

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-jq/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-jq/actions/workflows/validate.yml)

Neovim tree-sitter queries for **jq**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-jq",
...
- [ ] Changes are scoped to `jq` — do not include files for other languages
